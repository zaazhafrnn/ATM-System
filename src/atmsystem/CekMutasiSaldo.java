...
public class CekMutasiSaldo extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CekMutasiSaldo
     */
    public CekMutasiSaldo(String accountNumber, int accountId) {
        initComponents();
...
//                System.out.println("No transaction history available.");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CEK MUTASI REKENING");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Transaksi", "Tanggal", "Jenis Transaksi", "Nominal"
            }
        ) {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Jenis Transaksi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CekMutasiSaldo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
